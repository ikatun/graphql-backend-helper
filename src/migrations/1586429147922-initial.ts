...
export class initial1586429147922 implements MigrationInterface {
    name = 'initial1586429147922'

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "facebook_user" ("id" SERIAL NOT NULL, "email" text, "externalFacebookUserId" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer NOT NULL, CONSTRAINT "REL_01a740f2ec7df679ba79d3a86a" UNIQUE ("userId"), CONSTRAINT "PK_26a5bca228153435d0cd003796e" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "role" character varying NOT NULL DEFAULT 'USER', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "email_password_user" ("id" SERIAL NOT NULL, "email" character varying NOT NULL, "passwordHash" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer NOT NULL, CONSTRAINT "REL_bc6efd854b5c7d49ed37fd66c5" UNIQUE ("userId"), CONSTRAINT "PK_2a3872871cd374dba800c75c9b7" PRIMARY KEY ("id"))`, undefined);
